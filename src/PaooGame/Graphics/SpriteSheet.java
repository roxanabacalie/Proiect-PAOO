...
public class SpriteSheet {
    ...
    public BufferedImage crop2(int x, int y) {
        return spriteSheet.getSubimage(x * 50, y * 64, 50, 64);
    }

    public BufferedImage crop3(int x, int y) {
        return spriteSheet.getSubimage(x * 264, y * 128, 264, 128);
    }

    public BufferedImage crop4() {
        return spriteSheet.getSubimage(0, 0, 500, 500);
    }
